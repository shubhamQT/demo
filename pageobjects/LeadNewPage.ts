...
export class LeadNewPage {
  private static readonly L = {
    ...
    lastNameError: { strategy: 'css' as const, value: '.container .fieldLevelErrors a', actionKind: 'text' as const },
    companyError: { strategy: 'css' as const, value: '.container .fieldLevelErrors a', actionKind: 'text' as const },
    leadRecordHeader: { strategy: 'css' as const, value: '[name="entityLabel"] records-entity-label', actionKind: 'text' as const },
  } as const;
