...
export class HomePage {
  private static readonly L = {
    ...
    input157: { strategy: 'placeholder' as const, value: 'Number of meetings', shadowHost: 'lightning-primitive-input-simple', actionKind: 'textbox' as const },
    input159: { strategy: 'placeholder' as const, value: 'Number of calls', shadowHost: 'lightning-primitive-input-simple', actionKind: 'textbox' as const },
    input161: { strategy: 'placeholder' as const, value: 'Number of emails', shadowHost: 'lightning-primitive-input-simple', actionKind: 'textbox' as const },
    timeInterval: { strategy: 'css' as const, value: '[name="timeInterval"]', shadowHost: 'lightning-base-combobox', actionKind: 'button' as const },
    homeCardHeader6480: { strategy: 'css' as const, value: '#homeCardHeader_648:0', actionKind: 'text' as const },
    viewCalendar: { strategy: 'label' as const, value: 'View Calendar', actionKind: 'link' as const },
    homeCardHeader7130: { strategy: 'css' as const, value: '#homeCardHeader_713:0', actionKind: 'text' as const },
    ...
    homeCardHeader7980: { strategy: 'css' as const, value: '#homeCardHeader_798:0', actionKind: 'text' as const },
  ...
  async getInnerTextNotifications2New(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.Notifications2New));
  }

  async expectNotifications2NewVisible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewHidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewText(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.Notifications2New), expected, timeoutMs);
  }

  async expectNotifications2NewContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.Notifications2New), substring, timeoutMs);
  }

  async scrollNotifications2NewIntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.Notifications2New));
  }
  ...
  async fillInput157(value: string): Promise<void> {
    await fillWhenVisible(webLocator(this.page, HomePage.L.input157), value);
  }

  async clearInput157(): Promise<void> {
    await clearWhenVisible(webLocator(this.page, HomePage.L.input157));
  }

  async typeTextInput157(value: string): Promise<void> {
    await typeTextWhenVisible(webLocator(this.page, HomePage.L.input157), value);
  }

  async expectInput157Visible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async expectInput157Hidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async expectInput157Enabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async expectInput157Disabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async expectInput157Value(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.input157), expected, timeoutMs);
  }

  async expectInput157Focused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async scrollInput157IntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.input157));
  }

  async fillInput159(value: string): Promise<void> {
    await fillWhenVisible(webLocator(this.page, HomePage.L.input159), value);
  }

  async clearInput159(): Promise<void> {
    await clearWhenVisible(webLocator(this.page, HomePage.L.input159));
  }

  async typeTextInput159(value: string): Promise<void> {
    await typeTextWhenVisible(webLocator(this.page, HomePage.L.input159), value);
  }

  async expectInput159Visible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async expectInput159Hidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async expectInput159Enabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async expectInput159Disabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async expectInput159Value(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.input159), expected, timeoutMs);
  }

  async expectInput159Focused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async scrollInput159IntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.input159));
  }
  ...
  async getInnerTextHomeCardHeader6480(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader6480));
  }

  async expectHomeCardHeader6480Visible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Hidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Text(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.homeCardHeader6480), expected, timeoutMs);
  }

  async expectHomeCardHeader6480ContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.homeCardHeader6480), substring, timeoutMs);
  }

  async scrollHomeCardHeader6480IntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader6480));
  }
  ...
  async getInnerTextHomeCardHeader7130(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7130));
  }

  async expectHomeCardHeader7130Visible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Hidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Text(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.homeCardHeader7130), expected, timeoutMs);
  }

  async expectHomeCardHeader7130ContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.homeCardHeader7130), substring, timeoutMs);
  }

  async scrollHomeCardHeader7130IntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7130));
  }
  ...
  async getInnerTextHomeCardHeader7980(): Promise<string> {
    return getTextWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7980));
  }

  async expectHomeCardHeader7980Visible(timeoutMs = 30_000): Promise<void> {
    await expectVisible(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Hidden(timeoutMs = 30_000): Promise<void> {
    await expectHidden(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Text(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.homeCardHeader7980), expected, timeoutMs);
  }

  async expectHomeCardHeader7980ContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.homeCardHeader7980), substring, timeoutMs);
  }

  async scrollHomeCardHeader7980IntoView(): Promise<void> {
    await scrollIntoViewWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7980));
  }
  ...
  async clickNotifications2New(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.Notifications2New));
  }

  async doubleClickNotifications2New(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.Notifications2New));
  }

  async longPressNotifications2New(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.Notifications2New));
  }

  async expectNotifications2NewValue(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.Notifications2New), value, timeoutMs);
  }

  async expectNotifications2NewEnabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewDisabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewChecked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewUnchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewFocused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.Notifications2New), timeoutMs);
  }

  async expectNotifications2NewCount(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.Notifications2New), count, timeoutMs);
  }
  ...
  async expectInput157Text(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.input157), expected, timeoutMs);
  }

  async expectInput157ContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.input157), substring, timeoutMs);
  }

  async expectInput157Checked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async expectInput157Unchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.input157), timeoutMs);
  }

  async expectInput157Count(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.input157), count, timeoutMs);
  }

  async expectInput159Text(expected: string, timeoutMs = 30_000): Promise<void> {
    await expectText(webLocator(this.page, HomePage.L.input159), expected, timeoutMs);
  }

  async expectInput159ContainsText(substring: string, timeoutMs = 30_000): Promise<void> {
    await expectContainsText(webLocator(this.page, HomePage.L.input159), substring, timeoutMs);
  }

  async expectInput159Checked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async expectInput159Unchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.input159), timeoutMs);
  }

  async expectInput159Count(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.input159), count, timeoutMs);
  }
  ...
  async clickHomeCardHeader6480(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader6480));
  }

  async doubleClickHomeCardHeader6480(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader6480));
  }

  async longPressHomeCardHeader6480(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader6480));
  }

  async expectHomeCardHeader6480Value(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.homeCardHeader6480), value, timeoutMs);
  }

  async expectHomeCardHeader6480Enabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Disabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Checked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Unchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Focused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.homeCardHeader6480), timeoutMs);
  }

  async expectHomeCardHeader6480Count(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.homeCardHeader6480), count, timeoutMs);
  }
  ...
  async clickHomeCardHeader7130(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7130));
  }

  async doubleClickHomeCardHeader7130(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7130));
  }

  async longPressHomeCardHeader7130(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7130));
  }

  async expectHomeCardHeader7130Value(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.homeCardHeader7130), value, timeoutMs);
  }

  async expectHomeCardHeader7130Enabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Disabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Checked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Unchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Focused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.homeCardHeader7130), timeoutMs);
  }

  async expectHomeCardHeader7130Count(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.homeCardHeader7130), count, timeoutMs);
  }
  ...
  async clickHomeCardHeader7980(): Promise<void> {
    await clickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7980));
  }

  async doubleClickHomeCardHeader7980(): Promise<void> {
    await doubleClickWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7980));
  }

  async longPressHomeCardHeader7980(): Promise<void> {
    await longPressWhenVisible(webLocator(this.page, HomePage.L.homeCardHeader7980));
  }

  async expectHomeCardHeader7980Value(value: string, timeoutMs = 30_000): Promise<void> {
    await expectValue(webLocator(this.page, HomePage.L.homeCardHeader7980), value, timeoutMs);
  }

  async expectHomeCardHeader7980Enabled(timeoutMs = 30_000): Promise<void> {
    await expectEnabled(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Disabled(timeoutMs = 30_000): Promise<void> {
    await expectDisabled(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Checked(timeoutMs = 30_000): Promise<void> {
    await expectChecked(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Unchecked(timeoutMs = 30_000): Promise<void> {
    await expectUnchecked(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Focused(timeoutMs = 30_000): Promise<void> {
    await expectFocused(webLocator(this.page, HomePage.L.homeCardHeader7980), timeoutMs);
  }

  async expectHomeCardHeader7980Count(count: number, timeoutMs = 30_000): Promise<void> {
    await expectCount(webLocator(this.page, HomePage.L.homeCardHeader7980), count, timeoutMs);
  }
